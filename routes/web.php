...
Route::get('/event', [App\Http\Controllers\user\MainController::class, 'getEvent']);
// Route::get('/event_detail', [App\Http\Controllers\user\MainController::class, 'getEventDetail']);
Route::get('/membership', [App\Http\Controllers\user\MainController::class, 'getMembership']);
Route::get('/term', [App\Http\Controllers\user\MainController::class, 'getTerm']);
Route::get('/transaction', [App\Http\Controllers\user\MainController::class, 'getTransaction']);
Route::get('/security', [App\Http\Controllers\user\MainController::class, 'getSecurity']);
...
Route::prefix('user')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('payment', [App\Http\Controllers\PaymentController::class, 'getPay']); //getPay 

        Route::get('payment_return', [App\Http\Controllers\PaymentController::class, 'handlePaymentReturn'])->middleware('auth');
