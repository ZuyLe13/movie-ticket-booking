...
class MainController extends Controller
{
    ...
    public function getAboutUs(){
        return view("additional.about_us");
    }
    public function getRule(){
        return view("additional.rule");
    }
    public function getContact(){
        return view("additional.contact");
    }
    public function getEvent(){
        return view("additional.event");
    }
    // public function getEventDetail(){
    //     return view("additional.event_detail");
    // }
    public function getMembership(){
        return view("additional.membership");
    }
    public function getTerm(){
        return view("additional.term");
    }
    public function getTransaction(){
        return view("additional.transaction");
    }
    public function getSecurity(){
        return view("additional.security");
    }
